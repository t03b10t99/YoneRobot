...
# By @TroJanzHEX
from YoneRobot.tede.edit_1 import (  # pylint:disable=import-error
    black_white,
    box_blur,
    bright,
    g_blur,
...
from YoneRobot.tede.edit_2 import (  # pylint:disable=import-error
    cartoon,
    circle_with_bg,
    circle_without_bg,
    contrast,
...
from YoneRobot.tede.edit_3 import (  # pylint:disable=import-error
    black_border,
    blue_border,
    green_border,
    red_border,
)
from YoneRobot.tede.edit_4 import (  # pylint:disable=import-error
    inverted,
    removebg_plain,
    removebg_sticker,
    removebg_white,
...
from YoneRobot.tede.edit_5 import (  # pylint:disable=import-error
    normalglitch_1,
    normalglitch_2,
    normalglitch_3,
    normalglitch_4,
...
from YoneRobot import pbot as Client
...
async def photo(client: Client, message: Message):
    ...
    try:
        await client.send_message(
            ...
            text="Select your required mode from below!\nCuma mw bilang @tofik_dn ganteng :v",
...
__help__ = """
<b>IMAGE EDITOR</b>
TEDE have some advanced image editing tools inbuilt
